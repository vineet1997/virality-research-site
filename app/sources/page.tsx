...
export const metadata: Metadata = {
  ...
  description: 'Browse the books, papers, reviews, and cases behind Virality Research.',
  openGraph: { title: 'Source Library', description: 'Browse the books, papers, reviews, and cases behind Virality Research.' },
};
